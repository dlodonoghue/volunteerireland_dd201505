...
# each calendar year, segmented by the "How do you manage volunteers" field of the organisation publishing
...
vols_applied_by_mgt_style <- applications_opps_and_orgs %>%
...
View(vols_applied_by_mgt_style)