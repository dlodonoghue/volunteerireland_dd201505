...
# each calendar year, segmented by the "How number of employees" field of the organisation publishing
...
opps_and_orgs <-
    merge(x = opportunities[, c("Organisation.ID", "Opportunity_ID")],
          y = org[, c("Organisation.ID", "Num_Employees")],
...
vols_applied_by_org_size <- applications_opps_and_orgs %>%
